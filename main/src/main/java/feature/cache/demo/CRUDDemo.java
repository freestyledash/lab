package main.java.feature.cache.demo;
...
public class CRUDDemo {
    ...
    @ReadFromCacheFires(index = 0, prefix = "test/java/test", extractor = E.class)
    ...
    //存入/更新/ 会让对应的key失效
    @CleanCacheLatter(index = 0, prefix = "test/java/test", extractor = E.class)
